...
excel = xlrd.open_workbook(os.path.join(os.getcwd(), 'dbinsertscripts/Doctor-Schedule.xlsx'))
...
for i in range(1, 19):
    try:
        ...
        print(doc_name)
        doc_id=Doctor.objects.get(doctor_name=doc_name)
        print(doc_id)
...
#exec(open("dbinsertscripts/schedulescript.py").read())
