...
#   prizes=forms.CharField(label='prizes',max_length=1000,
#    widget=forms.Textarea(
#        attrs={'placeholder':'1st Prize \n2nd Prize
#                 \n3rd Prize\neg:\nRs10000/-\nRs7000/-\nRs5000/-\n'}))
...
class QuestionFormObjective(forms.Form):
    ...
    problem_statement = forms.CharField(label='Question', max_length=1000, widget=forms.Textarea(
        attrs={'placeholder': 'Description'}))
    image = forms.FileField(required=False)
    answer = forms.IntegerField(label='Answer', widget=forms.Textarea(
